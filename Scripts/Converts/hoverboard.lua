...
if game.Players.LocalPlayer.Character:FindFirstChild("MeshPartAccessory") then
    ...
    AlignCharacter(game.Players.LocalPlayer.Character["MeshPartAccessory"].Handle, game.Players.LocalPlayer.Character.Hover.Part, Vector3.new(0, 0, 0), Vector3.new(-90, 0, -135))
    for index, asset in pairs(game.Players.LocalPlayer.Character.Hover:GetChildren()) do
