...
local Mouse,mouse,UserInputService,ContextActionService = Player:GetMouse(),Player:GetMouse(),game:GetService("UserInputService"),game:GetService("ContextActionService")
...
if game.Players.LocalPlayer.Character:FindFirstChild("Accessory (Clock)") then
	game.Players.LocalPlayer.Character["Accessory (Clock)"].Handle.AccessoryWeld:Destroy()
	AlignCharacter(game.Players.LocalPlayer.Character["Accessory (Clock)"].Handle, game.Players.LocalPlayer.Character.Scythe.Handle, Vector3.new(0, 1, -1), Vector3.new(0, -90, 0))
	...
	sendNotification("Moon Convert", "It is recommended to wear the hats used for this script... You can get the hats by using \"get hats -h soul reaper\"", 7)
end
